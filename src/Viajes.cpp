...
Viajes::Viajes(lista *listaAtributo)
{
    ...
    destino = listaAtributo->pasarAtributo();
    cout<<"destino:"<<destino<<endl;

    fechaSalida = listaAtributo->pasarAtributo();
    cout<<"Fecha salida"<<fechaSalida<<endl;

    fechaLlegada = listaAtributo->pasarAtributo();
    cout<<"Fecha llegada:" <<fechaLlegada<<endl;
